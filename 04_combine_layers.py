...
Usage:
------
    /c/mambaforge/envs/9629/python.exe 04_combine_layers.py "2023"
        * first argument: folder name that contains the files, and where output goes

    for year in `seq 2009 2022`
    do
        /c/mambaforge/envs/9629/python.exe 04_combine_layers.py $year
    done
"""
...
if len(files) == 0:
    raise ValueError(f"No edge files (*.npz) found in folder {folder}!")
else:
